  ...
  <aside class="admin-sidebar" id="adminSidebar">
    ...
    <div class="admin-user-section">
      <?php if (isset($_SESSION['user'])): ?>
        <a href="/admin/profile" class="admin-user-card" title="My Profile">
      ...
      <?php else: ?>
        <div class="admin-user-card-legacy">
          <div class="admin-user-avatar">
            <div class="admin-user-initials">AD</div>
          </div>
          <div class="admin-user-info">
    ...
    <nav class="admin-nav">
      ...
      <?php if ((isset($_SESSION['user']) && $_SESSION['user']['role'] === 'admin') || isset($_SESSION['admin'])): ?>
      <a href="/admin/users" class="admin-nav-item <?= strpos($currentPath, '/admin/users') === 0 ? 'active' : '' ?>">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <?php if (isset($_SESSION['user'])): ?>
      <a href="/admin/profile" class="admin-nav-item <?= $currentPath === '/admin/profile' ? 'active' : '' ?>">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
